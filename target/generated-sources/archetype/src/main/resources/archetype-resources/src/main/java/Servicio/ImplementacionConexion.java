	...
	private String[] configuracionConexion() {
		...
		try {
			...
			propiedadesConexionPostgresql.load(new FileInputStream(new File(
					"C:${symbol_escape}${symbol_escape}Users${symbol_escape}${symbol_escape}Puesto4${symbol_escape}${symbol_escape}Desktop${symbol_escape}${symbol_escape}Pablo${symbol_escape}${symbol_escape}DWS${symbol_escape}${symbol_escape}${package}${symbol_escape}${symbol_escape}src${symbol_escape}${symbol_escape}main${symbol_escape}${symbol_escape}java${symbol_escape}${symbol_escape}Util${symbol_escape}${symbol_escape}conexion_postgresql.properties.sql")));
